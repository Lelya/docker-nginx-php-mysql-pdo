...
значений 'normal', 'illegal', 'failed', 'success';normal'normal', 'illegal', 'failed', 'success'; и 'normal', 'illegal', 'failed', 'success';success'normal', 'illegal', 'failed', 'success';. В конструкторе выполняются методы create и fill.
Весь код должен быть прокомментирован в стиле PHPDocumentor'normal', 'illegal', 'failed', 'success';а.
___
